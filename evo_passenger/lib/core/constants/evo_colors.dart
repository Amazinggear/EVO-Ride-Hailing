...
/// EVO Design System — Color Palette
/// Source: Reference designs (Passenger Home, Driver Dark, Payment screens)
class EvoColors {
  EvoColors._();
  ...
  // Passenger App — Light Mode
  static const Color lightBg = Color(0xFFF5F5F5);
  static const Color lightSurface = Color(0xFFFFFFFF);
  static const Color lightGreenBg = Color(0xFFE8F5E9); // Payment screen tint
